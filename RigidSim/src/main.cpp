...
//
// Description: IGR202 - Practical - Rigid Body Simulator (DO NOT distribute!)
//
...
struct Scene {
  ...
  RigidSolver solver = RigidSolver(nullptr, Vec3f(0, -0.98, 0), 0.01f);
...
void initGLFW()
{
  ...
  // Create the window
  g_window = glfwCreateWindow(g_windowWidth, g_windowHeight, "IGR202 - Practical - Rigid", nullptr, nullptr);
  if(!g_window) {
